...
{
    const char* pszTimestamp = "Rafsen RAF - The Iraqi Crypto 30/03/2026";
...
public:
    CMainParams() {
        ...
        consensus.powLimit = uint256S("0x00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // Rafsen: mainnet
        ...
        consensus.defaultAssumeValid = uint256S("0x951886fb79bed1ef25a83f991be93bddd6ad41b52103f68464889481554ba34e"); // Rafsen Genesis

        // AuxPoW parameters
        consensus.nAuxpowChainId = 0x0000; // 98 - Josh Wise!
        ...
        genesis = CreateGenesisBlock(1774950005, 3560849, 0x1e0ffff0, 1, 50 * COIN);
        ...
        // Rafsen Seed Nodes
        vSeeds.push_back(CDNSSeedData("rafsencoin.com", "seed.rafsencoin.com"));
        // Rafsen: hardcoded bootstrap node
        vSeeds.push_back(CDNSSeedData("rafsencoin.com", "187.77.87.53"));
        ...
        vFixedSeeds = std::vector<SeedSpec6>(pnSeed6_main, pnSeed6_main + ARRAYLEN(pnSeed6_main)); // Rafsen fixed seeds
        ...
        checkpointData = (CCheckpointData) {
            ...
            (      0, uint256S("0x951886fb79bed1ef25a83f991be93bddd6ad41b52103f68464889481554ba34e"))
        };

        chainTxData = ChainTxData{
            // Rafsen Genesis Block
            1774950005, // UNIX timestamp
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // Rafsen: easy mining
        consensus.nPowTargetTimespan = 4 * 60 * 60; // pre-digishield: 4 hours
        consensus.nPowTargetSpacing = 60; // 1 minute
        consensus.fPowNoRetargeting = false;
