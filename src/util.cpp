...
const char * const BITCOIN_CONF_FILENAME = "rafsen.conf";
const char * const BITCOIN_PID_FILENAME = "rafsend.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Rafsen";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Rafsen";
#else
    // Unix
    return pathRet / ".rafsen";
#endif
#endif
}
