...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Rafsen Core repository on GitHub"),
        tr("Services that claim to double your rafsens are always ponzi schemes")
    };
