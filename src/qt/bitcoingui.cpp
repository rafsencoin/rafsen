...
// Copyright (c) 2021-2023 The Rafsen Core developers
    ...
    platformStyle(_platformStyle)
{
    ...
    // Rafsen: load fallback font in case Comic Sans is not available on the system
    ...
    // Rafsen: load this bundled font for Settings -> Options in case it's not available on the system
    ...
    // Rafsen: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // Rafsen: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Rafsen address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and rafsen: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Rafsen addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Rafsen addresses"));
    ...
    openAction->setStatusTip(tr("Open a rafsen: URI or payment request"));

    importPrivateKeyAction = new QAction(platformStyle->TextColorIcon(":/icons/address-book"), tr("&Import Private Key..."), this);
    importPrivateKeyAction->setStatusTip(tr("Import a Rafsen private key"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Rafsen command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Rafsen network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("Rafsen"); // default title
