...
// Copyright (c) 2022-2024 The Rafsen Core developers
...
const QString BITCOIN_IPC_PREFIX("rafsen:");
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(ipcServerName)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start rafsen: click-to-pay handler"));
        }
        else {
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        if (GUIUtil::parseBitcoinURI(s, &recipient))
        {
            ...
            Q_EMIT message(tr("URI handling"),
                tr("URI cannot be parsed! This can be caused by an invalid Rafsen address or malformed URI parameters."),
