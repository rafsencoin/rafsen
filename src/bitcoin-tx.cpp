...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s rafsen-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  rafsen-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rafsen transaction") + "\n" +
              "  rafsen-tx [options] -create [commands]   " + _("Create hex-encoded rafsen transaction") + "\n" +
              "\n";
