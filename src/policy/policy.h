...
/** Recommended transaction fee by Rafsen Core developers
  *
 ...
 *
 *  Rafsen:    Increment mempool limits and accept RBF in steps of 0.0001 RAF
...
/**
 * Rafsen: Default dust limit that is evaluated when considering whether a
...
/**
 * Rafsen: Default hard dust limit that is evaluated when considering whether
